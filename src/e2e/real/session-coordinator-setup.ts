 ...
 *
 * Uses AdapterResolver + SessionCoordinator.createSession() to set up
...
function isLauncherStateStorage(
  storage: SessionStorage,
): storage is SessionStorage & LauncherStateStorage {
  return (
...
/**
 * Set up a real backend session using SessionCoordinator.createSession().
 *
