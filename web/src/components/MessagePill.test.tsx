...
describe("MessagePill", () => {
  it('renders with data-flow-id for direction "out"', () => {
    ...
    const { container } = render(
      <MessagePill message={msg} dimmed={false} onHoverStart={noop} onHoverEnd={noop} />,
    );
  ...
  it('shows ↙ arrow for direction "in"', () => {
    ...
    render(<MessagePill message={msg} dimmed={false} onHoverStart={noop} onHoverEnd={noop} />);
  ...
  it("applies opacity-30 class when dimmed", () => {
    ...
    const { container } = render(
      <MessagePill message={msg} dimmed={true} onHoverStart={noop} onHoverEnd={noop} />,
    );
    const root = container.firstElementChild as HTMLElement;
